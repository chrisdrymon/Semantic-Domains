# Given a lemma, its part of speech, and a lemma of its dependent's dependent, this will return the PMIs of the
# dependant's semantic domains so long as the dependent does not have a dependent of the given lemma. It's especially
# useful for investigating how the presence of the article effects PMIs.
